...
class ChartOfAccounts
{
    ...
    public const STANDARD_TH = [
        ...
        ['code' => '2132-01', 'name' => 'ภาษีหัก ณ ที่จ่ายค้างจ่าย ภงด.1', 'name_en' => 'WHT payable (PND.1, payroll)', 'type' => 'liability', 'role' => 'wht_payable_pnd1'],
        ['code' => '2133-00', 'name' => 'ประกันสังคมค้างจ่าย', 'name_en' => 'Social security payable', 'type' => 'liability', 'role' => 'social_security_payable'],
        ...
        ['code' => '5300-03', 'name' => 'เงินสมทบประกันสังคมส่วนนายจ้าง', 'name_en' => 'Social security — employer share', 'type' => 'expense'],
        ['code' => '5410-00', 'name' => 'ต้นทุนขาย', 'name_en' => 'Cost of goods sold', 'type' => 'expense', 'role' => 'cogs'],
