{{-- ไอคอนแถบเมนูล่าง (Heroicons outline, stroke). ใช้โดย layouts/portfolio.blade.php
     รับตัวแปร: $icon (ชื่อไอคอน), $class (ขนาด/สี — default h-6 w-6) --}}
@php
    $paths = [
        ...
        'trending-up' => '<path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18 9 11.25l4.306 4.307a11.95 11.95 0 0 1 5.814-5.519l2.74-1.22m0 0-5.94-2.281m5.94 2.28-2.28 5.941" />',
        ...
        'repeat'      => '<path stroke-linecap="round" stroke-linejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0 3.181 3.183a8.25 8.25 0 0 0 13.803-3.7M4.031 9.865a8.25 8.25 0 0 1 13.803-3.7l3.181 3.182m0-4.991v4.99" />',
    ];
    $icon = $icon ?? 'home';
@endphp
<svg class="{{ $class ?? 'h-6 w-6' }}" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" aria-hidden="true">
