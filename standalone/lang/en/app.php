...
return [
    ...
    'landing' => [
        ...
        'eyebrow' => 'Accounting for Thai SMEs',
        'hero_title' => 'Books, tax & documents in one place',
        'hero_sub' => 'Issue tax invoices and receipts, track receivables and payables, run VAT and withholding-tax reports, and hand clean figures to your accountant — all in one app.',
        'hero_note' => 'Start free — no credit card required.',
        'cta_primary' => 'Start free',
        'cta_pricing' => 'See pricing',
        'feat_docs_title' => 'Every document',
        'feat_docs_desc' => 'Tax invoices, receipts and purchase bills, printable instantly with automatic numbering.',
        'feat_arap_title' => 'Receivables & payables',
        'feat_arap_desc' => 'Track what you are owed and what you owe; record payments and settle balances.',
        'feat_tax_title' => 'Tax, automated',
        'feat_tax_desc' => '7% VAT and withholding tax calculated and posted for you, with 50-ทวิ certificates.',
        'feat_reports_title' => 'Financial statements',
        'feat_reports_desc' => 'Trial balance, P&L and balance sheet, live from your posted entries.',
        'feat_handoff_title' => 'Accountant hand-off',
        'feat_handoff_desc' => 'Export the journal and tax reports as files to send straight to your accountant.',
        'feat_multi_title' => 'Multiple businesses',
        'feat_multi_desc' => 'Run several businesses from one account, with separate data and teams.',
        'pricing_title' => 'Pricing that fits',
        'pricing_sub' => 'Start free, upgrade as you grow, cancel anytime.',
        'popular' => 'Popular',
        'final_title' => 'Ready to make bookkeeping easier?',
        'final_sub' => 'Sign up free today and issue your first document in two minutes.',
