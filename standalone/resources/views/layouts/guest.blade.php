        ...
        <div class="flex min-h-screen flex-col lg:flex-row">
            ...
            <aside class="relative hidden overflow-hidden lg:flex lg:w-1/2 lg:flex-col lg:justify-between lg:p-12 xl:p-16">
                ...
                <a href="/" class="relative inline-flex items-center gap-2 self-start">
                    <span class="grid h-10 w-10 place-items-center rounded-xl bg-white/15 text-lg font-bold text-white ring-1 ring-white/30 backdrop-blur">{{ mb_strtoupper(mb_substr(config('app.name'), 0, 1)) }}</span>
