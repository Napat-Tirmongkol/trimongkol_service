...
- **สเตชั่นครัว** (เคสจริง: ปิ้งย่าง/ส้มตำ/ครัว/คาเฟ่เครื่องดื่ม) — กดส่งครัวครั้งเดียว ใบครัวแตกเป็น 1 ใบ/สเตชั่น แต่ละจุดพิมพ์เลือกรับเฉพาะสเตชั่นตัวเอง (ปริ้นเตอร์ตัวเดียวทั้งร้านก็ได้) · mapping 2 ชั้น หมวด→default เมนู→override · จานไม่ระบุสเตชั่นไม่ตกหล่น · รายงานยอดต่อสเตชั่น
- ครอบคลุม: การตัดสินใจหลัก 12 ข้อ (ตาราง `pos_*` แยกจากบัญชี, auth แบบ queue, เงินผ่าน `Money`, ราคารวม VAT/ใบกำกับภาษีอย่างย่อ, service charge, modifier เป็น JSON snapshot, งานพิมพ์ผ่านคิวกลาง, สเตชั่นครัว first-class) · data model 15 ตาราง (+ตารางชำระค่าแพ็กเกจ) · ผังโต๊ะ/ใบส่งครัว/ตัวเลือกความเผ็ด-ท็อปปิ้ง · routes+สิทธิ์ · แพ็กเกจ Free (5 โต๊ะ, ใบครัวรวม)/฿299/฿699 + QR สั่งเองที่โต๊ะเป็นฟีเจอร์ Pro ในอนาคต
