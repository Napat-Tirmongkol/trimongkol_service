...
- ครอบคลุม: การตัดสินใจหลัก 10 ข้อ (ตาราง `pos_*` แยกจากบัญชี, auth แบบ queue, เงินผ่าน `Money`, ราคารวม VAT/ใบกำกับภาษีอย่างย่อ, service charge, modifier เป็น JSON snapshot) · data model 13 ตาราง (+ตารางชำระค่าแพ็กเกจ) · ผังโต๊ะ/ใบส่งครัว/ตัวเลือกความเผ็ด-ท็อปปิ้ง · routes+สิทธิ์ · แพ็กเกจ Free (5 โต๊ะ)/฿299/฿699 + QR สั่งเองที่โต๊ะเป็นฟีเจอร์ Pro ในอนาคต
